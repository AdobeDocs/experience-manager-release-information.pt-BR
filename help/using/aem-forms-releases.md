...
<table>
  ...
  <tr>
    ...
    <td><p>Complemento de pacotes do AEM Forms 6.5 LTS: 6.1.176 <br/></p><!--<p>AEM Forms 6.5 LTS Compatibility Package:-->  </td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>Instaladores de correções do AEM Forms no OSGi</b></div>
      ...
      <div style="margin: 10px 0;"><b>Instaladores completos do AEM Forms no JEE</b></div>
      ...
      <div style="margin: 10px 0;"><b>Instaladores de correções do Forms Designer de 64 bits</b></div>
  ...
  <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>Instaladores de correções do AEM Forms no OSGi</b></div>
      ...
      <div style="margin: 10px 0;"><b>Instalador do Workbench</b></div>
  ...
  <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>Instaladores de correções do AEM Forms no OSGi</b></div>
      ...
      <div style="margin: 10px 0;"><b>Instalador completo do Forms Designer de 64 bits</b></div>
   ...
   <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>Instaladores de correção do AEM Forms no OSGi</b></div>
      ...
      <div style="margin: 10px 0;"><b>Instalador de correção do Forms Designer</b></div>
   ...
   <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>Instaladores de correção do AEM Forms no OSGi</b></div>
      ...
      <div style="margin: 10px 0;"><b>Workbench do Forms</b></div> 
   ...
   <tr>
    ...
    <td>
     <ul>
      ...
      <div style="margin: 10px 0;"><b>Instaladores de patch do JEE</b></div>
