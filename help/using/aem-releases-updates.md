...
As atualizações [!DNL Experience Manager] 6.5 são fornecidas por meio de pacotes de serviços e incluem novos recursos, aprimoramentos e correções de erros.
...
As atualizações do produto [!DNL Experience Manager] 6.5 LTS são fornecidas por meio de pacotes de serviços e incluem novos recursos, aprimoramentos e correções de erros.
