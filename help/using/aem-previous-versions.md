...
1. Em um navegador da web, abra a página da documentação. Usando o AEM 5.6.1 como exemplo, o URL pode ser: http://localhost:4502/libs/aem-docs/content/en/cq/5-6-1.html.
