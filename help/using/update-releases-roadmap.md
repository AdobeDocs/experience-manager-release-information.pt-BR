...
O [!DNL Experience Manager] as a [!DNL Cloud Service] novos recursos são fornecidos por meio de uma [ativação mensal de recursos](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current), enquanto os aprimoramentos e correções de erros são fornecidos duas vezes por mês até as [versões de manutenção](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest).
...
| Lançamento de recurso [2026.1.0](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/release-notes/2026/2026-1-0) | Ativação do recurso | 29 de janeiro de 2026 | Ativado |
...
| Lançamento de recurso [2026.2.0](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/release-notes/2026/2026-2-0) | Ativação do recurso | 3 de março de 2026 | Ativado |
...
| Lançamento de recurso [2026.3.0](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/release-notes/release-notes/2026/2026-3-0) | Ativação do recurso | sexta-feira, 26 de março de 2026 | Ativado |
...
| Versão de manutenção [26309](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/maintenance/2026/2026-5-0#release-26309) | Atualização automática | 25 a 27 de maio de 2026 | Atualizado |
...
| Versão de manutenção [26353](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/maintenance/2026/2026-6-0#release-26353) | Atualização automática | 8–10 de junho de 2026 | Atualizado |
| Versão de manutenção [26773](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/maintenance/2026/2026-6-0#release-26773) | Atualização automática | 22-24 de junho de 2026 | Atualizado |
| Versão do Recurso [2026.6.0](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/release-notes/2026/2026-6-0) | Ativação do recurso | 25 de junho de 2026 | Ativado |
| Versão de manutenção [26908](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/maintenance/2026/2026-7-0#release-26908) | Atualização automática | 6-8 de julho de 2026 | Atualizado |
| Versão de manutenção [27083](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/maintenance/2026/2026-7-0#release-27083) | Atualização automática | 20-22 de julho de 2026 | Atualizado |
| Versão do Recurso [2026.7.0](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current) | Ativação do recurso | 30 de julho de 2026 | Ativado |

### Próximas versões do [!DNL Cloud Service] {#upcoming}

| Versão | Evento | Programação | Status |
|---|---|---|---|
| Versão de manutenção [27293](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest) | Atualização automática | 3-5 de agosto de 2026 | Destino |
| Versão de manutenção | Atualização automática | 17-19 de agosto de 2026 | Destino |
| Versão do Recurso 2026.8.0 | Ativação do recurso | 27 de agosto de 2026 | Destino |
| Versão de manutenção | Atualização automática | 31 de agosto a 2 de setembro de 2026 | Destino |
| Versão de manutenção | Atualização automática | 14-16 de setembro de 2026 | Destino |
| Versão do Recurso 2026.9.0 | Ativação do recurso | 24 de setembro de 2026 | Destino |
| Versão de manutenção | Atualização automática | 28-30 de setembro de 2026 | Destino |

## [!DNL Experience Manager] no local e Managed Services {#aem-on-prem-managed-services}

As atualizações de produtos, em termos de novos recursos, melhorias e correções de erros para versões compatíveis do [!DNL Experience Manager] no local e Managed Services, são fornecidas por meio de Pacotes de serviços e Pacotes de correções cumulativos (CFPs). Essa abordagem permite uma adoção mais rápida de atualizações de produtos por meio de lançamentos frequentes. A programação para os próximos lançamentos de atualizações de produtos é a seguinte:
...
| [!DNL Experience Manager] 6.5 [Pacote de serviços 22](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-22) | 6.5.22.0 | Pacote de serviços | 21 de novembro de 2024 | Ativado |
...
| [!DNL Experience Manager] 6.5 [Pacote de serviços 24](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/service-pack/6-5-24) | 6.5.24.0 | Pacote de serviços | quinta-feira, 26 de novembro de 2025 | Ativado |
...
> 
>Ambos os caminhos são cobertos pelo AEM 6.5 LTS. Consulte as [Perguntas frequentes sobre o AEM 6.5](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/release-notes/faq) para obter detalhes.

>[!NOTE]
>
> 6.5.26.0 é a última versão do pacote de serviço com suporte do AEM 6.5.
>
> Cada Service Pack tem suporte por até 18 meses a partir de seu lançamento, até 28 de fevereiro de 2027. Consulte [Produtos e períodos de suporte técnico](https://helpx.adobe.com/support/programs/eol-matrix.html#cq).
